...
class Repository:
    ...
    def create_department(self, name, dept):
    ...
    def create_company(self):
        back = self.create_department('Back Dept', dept=None)
        front = self.create_department('Front Dept', back)
        design = self.create_department('Design Dept', front)
